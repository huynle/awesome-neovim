...
## AI
- [huynle.com/ogpt.nvim](https://github.com/huynle/ogpt.nvim) - General Neovim GPT assistant (current support Ollama, Google Gemini, Guggingface/Textgenui, Anthropic, OpenAI ) with custom template expander that allow you to have total control over the construction of your requests/questions.
